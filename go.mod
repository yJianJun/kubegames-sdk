module github.com/kubegames/kubegames-sdk

go 1.17

replace (
	github.com/kubegames/kubegames-hall v1.0.0 => ../kubegames-hall
	github.com/kubegames/kubegames-operator v1.0.0 => ../kubegames-operator
	github.com/kubegames/kubegames-proxy v1.0.0 => ../kubegames-proxy
)
...
require (
	...
	github.com/kubegames/kubegames-hall v1.0.0
